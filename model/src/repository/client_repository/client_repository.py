...
from model.src.repository.models.models import ClientTable, AddresseesTable, AbstractBase
...
class ClientRepository(ClientOriginRepository):
    ...
    async def get_all_entities(self) -> list[ClientTable]:
    ...
    async def add_entity(self, entity: ClientTable, number: AddresseesTable):
